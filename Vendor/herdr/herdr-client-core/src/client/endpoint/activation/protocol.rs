// Derived from herdr b99002ac99b09e00b4ca692436cb15a6b0d676f1 src/client/endpoint/activation/protocol.rs (1:219), Apache-2.0.
...
pub(super) fn coherent_completion_surface(
    ...
    crate::surface::validate_surface(&surface)?;
