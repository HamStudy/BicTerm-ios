// Derived from herdr b99002ac99b09e00b4ca692436cb15a6b0d676f1 src/client/endpoint/activation/model.rs (1:174), Apache-2.0.
...
pub struct EndpointActivationIntent {
    ...
    pub target: Option<crate::client::shell::ClientEndpointFocusTarget>,
}
