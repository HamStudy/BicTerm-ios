// Derived from herdr b99002ac99b09e00b4ca692436cb15a6b0d676f1 src/client/endpoint/message_policy.rs (1:124), Apache-2.0.
...
pub fn is_presentation_effect(message: &ServerMessage) -> bool {
    matches!(
        message,
...
pub fn accepts_endpoint_message(
