...
|------|---------------|---------|-----------|--------------|
| SwiftTerm | 1.20.0 (`v1.20.0`, commit `5d14406844143538cd8f8851d2d8a67c1fe443e5`) | MIT | `SwiftTerm/Sources/SwiftTerm/iOS/iOSTerminalView.swift` | 8 hunks, inline `BICTERM-PATCH hunk N` markers, documented in `SwiftTerm/BICTERM-PATCH.md` |
...
- OSC 52 remote clipboard writes stay denied at the fork's delegate; paste is a local user action only.
