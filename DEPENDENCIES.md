...
Review date: 2026-09-03 (task T3 key layer); amended 2026-09-04 (task T8 vendored swift-nio-ssh fork); amended 2026-09-11 (AGPL/copyleft removal — single permissive-only build); amended 2026-09-12 (herdr-support T11 — fixture-binary provenance, no graph change); amended 2026-09-13 (herdr-embed T7 — embed xcframework provenance, no graph change)
